...
const STATIC_ROUTES: Route[] = [
  ...
  { path: "/cursuri-araba", title: "Cursuri de Arabă (Libaneză) — București & Online | A1–C2", description: "Cursuri de limbă arabă (dialect libanez, levantin) cu profesor nativ — București și online. Grupe A1–C2, lecții private 1:1, copii și adolescenți. Probă gratuită." },
  ...
  { path: "/araba-pentru-partener", title: "Arabă Libaneză pentru Partener și Socri — Expresii și Curs 1:1", description: "Vrei să vorbești cu partenerul libanez și cu familia lui? Expresii esențiale pentru prima întâlnire cu socrii, alintări, urări la masă și un plan realist de învățare în 6 săptămâni." },
  { path: "/araba-in-familie", title: "Arabă Libaneză în Familie — Copii Bilingvi și Părinți | Ghid", description: "Cum crești un copil bilingv româno-libanez: rutine zilnice, regula „o persoană, o limbă”, expresii de acasă și cursuri pentru copii și părinți, în București sau online." },
  ...
  { path: "/en/learn-levantine-arabic", title: "Learn Lebanese & Levantine Arabic Online | Native Teacher, Free Trial", description: "Learn Lebanese Arabic — the Levantine dialect — with a native instructor. One dialect, ~90% comprehension across Lebanon, Syria, Jordan and Palestine. Live 1-on-1 and small-group courses online, A1–C2. Speak from lesson one, free trial.", lang: "en", canonical: "/en/learn-lebanese-arabic" },
  ...
  { path: "/en/arabic-dialects-guide", title: "Arabic Dialects Guide & Map — Levantine, Egyptian, Gulf, Maghrebi | 2026", description: "Complete guide and map of the Arabic dialects: Levantine (North vs South Shami — Lebanese, Syrian, Jordanian, Palestinian), Egyptian–Sudanese, Maghrebi, Peninsular (Gulf, Saudi, Yemeni), Mesopotamian, plus MSA. Written by a native Lebanese teacher." },
  { path: "/en/levantine-arabic-dialects-map", title: "Arabic Dialects Guide & Map — Levantine, Egyptian, Gulf, Maghrebi | 2026", description: "Complete guide and map of the Arabic dialects: Levantine (North vs South Shami — Lebanese, Syrian, Jordanian, Palestinian), Egyptian–Sudanese, Maghrebi, Peninsular (Gulf, Saudi, Yemeni), Mesopotamian, plus MSA. Written by a native Lebanese teacher.", lang: "en", canonical: "/en/arabic-dialects-guide" },
  ...
  { path: "/en/best-arabic-course", title: "Best Arabic Course 2026 — How to Choose | Lebanese vs MSA", description: "How to choose the best Arabic course: Lebanese (Levantine) dialect vs Modern Standard Arabic, group vs private vs online vs apps. Honest comparison, prices and common mistakes." },
