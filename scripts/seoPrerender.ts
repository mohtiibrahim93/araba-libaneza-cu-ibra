...
const STATIC_ROUTES: Route[] = [
  ...
  { path: "/cursuri-araba", title: "Cursuri de Arabă Libaneză 2026 — Grup, Private & Copii | București și Online", description: "Cursuri de arabă libaneză cu profesor nativ: grup (A1–C2), lecții private 1:1 și curs pentru copii — fizic în București sau online. Prima lecție de probă e gratuită." },
  ...
  { path: "/cursuri/privat", title: "Lecții private de arabă libaneză (1:1) | București & Online", description: "Lecții private 1:1 de arabă libaneză cu profesor nativ — online sau în București, ritm și program adaptate. Solicită o lecție privată.", canonical: "/cursuri/private" },
