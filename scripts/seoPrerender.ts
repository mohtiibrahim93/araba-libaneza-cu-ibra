...
const STATIC_ROUTES: Route[] = [
  ...
  { path: "/cursuri-araba-bucuresti", title: "Cursuri de Arabă în București | Profesor Nativ", description: "Cursuri de arabă libaneză în București cu profesor nativ libanez, la Raduga Creative Center (Str. Icoanei 80). Grupe mici, niveluri A1–C2, adulți și copii. Probă gratuită." },
