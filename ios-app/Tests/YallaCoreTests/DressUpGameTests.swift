...
struct DressUpGameTests {
    ...
    func rewards() {
        ...
        let r1 = state.completeScene(unitID: "u", day: "d")
        #expect(r1 == 10)
        let r2 = state.completeScene(unitID: "u", day: "d")
        #expect(r2 == 2)
    ...
    func dailyLimit() {
        var state = DressUpGameState()
        let r10 = state.earn(25, day: "d1")
        #expect(r10 == 25)
        let r11 = state.earn(10, day: "d1")
        #expect(r11 == 5)
        let r12 = state.earn(3, day: "d1")
        #expect(r12 == 0)
        let r13 = state.completeScene(unitID: "u", day: "d1")
        #expect(r13 == 0)
        #expect(state.earned(on: "d1") == 30)
        let r14 = state.earn(3, day: "d2")
        #expect(r14 == 3)
