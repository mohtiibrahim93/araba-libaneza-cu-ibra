...
const T = {
  ro: { preview: 'Programarea ta a fost reprogramată.', hi: (n?: string) => n ? `Salut, ${n}!` : 'Salut!', body: 'Programarea ta a fost actualizată cu succes.', oldWhen: 'Înainte', newWhen: 'Acum', meet: 'Link Meet', manageCta: 'Gestionează programarea', footer: 'Pe curând,' },
  en: { preview: 'Your booking was rescheduled.', hi: (n?: string) => n ? `Hi, ${n}!` : 'Hi!', body: 'Your booking has been successfully rescheduled.', oldWhen: 'Was', newWhen: 'Now', meet: 'Meet link', manageCta: 'Manage booking', footer: 'See you soon,' },
} as const
...
export const template = {
  ...
  previewData: { name: 'Maria', oldWhenLabel: '12 iun. 2026, 14:00', newWhenLabel: '14 iun. 2026, 16:00', meetLink: 'https://meet.google.com/abc', manageUrl: 'https://example.com/booking/manage/xxx', lang: 'ro' },
