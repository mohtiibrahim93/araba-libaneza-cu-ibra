...
export const template = {
  ...
  previewData: { name: 'Maria', whenLabel: '12 iun. 2026, 14:00', durationMin: 60, format: 'online', meetLink: 'https://meet.google.com/abc-defg-hij', manageUrl: 'https://example.com/booking/manage/xxx', lang: 'ro' },
