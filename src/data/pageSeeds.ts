...
export const PAGE_SEEDS: PageSeed[] = [
  ...
  },
  {
    ...
    "meta_title": "Arabă Libaneză pentru Partener și Socri — Expresii și Curs 1:1",
    "meta_description": "Vrei să vorbești cu partenerul libanez și cu familia lui? Expresii esențiale pentru prima întâlnire cu socrii, alintări, urări la masă și un plan realist de învățare în 6 săptămâni.",
    "h1": "Arabă libaneză pentru partener și familia lui",
  ...
  {
    "path": "/cursuri-araba",
    "meta_title": "Cursuri de Arabă Libaneză 2026 — Grup, Private & Copii | București",
    "meta_description": "Cursuri de arabă libaneză cu profesor nativ: grup A1–C2, lecții private 1:1 și curs pentru copii — fizic în București sau online. Prima probă gratuită.",
    "h1": "Cursuri de arabă libaneză cu profesor nativ — grup, private și pentru copii",
  ...
  },
  {
    ...
    "h1": "Dialectele arabe: ghid pe înțelesul tuturor",
  ...
  },
  {
    ...
    "meta_title": "Arabic Dialects Guide — Levantine, Egyptian, Gulf, Maghrebi | 2026",
    "meta_description": "Complete guide to Arabic dialects: Levantine (Lebanese, Syrian, Jordanian, Palestinian), Egyptian–Sudanese, Maghrebi, Peninsular (Gulf, Saudi, Yemeni), Mesopotamian, plus MSA. Written by a native Lebanese teacher.",
    "h1": "Arabic dialects — the complete guide (Levantine, Egyptian, Gulf, Maghrebi & more)",
  ...
  },
  {
    ...
    "meta_description": "The complete step-by-step guide to learning Lebanese Arabic in 2026: recommended learning path, weekly lesson structure, level-by-level timeline (A1→C1), and the exact study routine that works. Written by a native Lebanese teacher.",
  ...
  },
  {
    ...
    "meta_description": "Learn Lebanese Arabic (Levantine dialect) with a native instructor. Live 1-on-1 and small-group courses online worldwide, from beginner (A1) to advanced. Speak from lesson one — free trial.",
  ...
  },
  {
    ...
    "meta_title": "Învață Arabă Libaneză Gratis — Resurse, PDF-uri și Lecții | 2026",
    "meta_description": "Resurse gratuite pentru arabă libaneză: cheat-sheet arabizi, 100 de expresii esențiale în PDF, plan de 30 de zile, canale YouTube și o mini-lecție cu pronunție. Fără costuri.",
    "h1": "Învață arabă libaneză gratis: resurse, lecții și PDF-uri",
