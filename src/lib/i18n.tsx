...
export const translations = {
  ro: {
    ...
    groupDesc: "Prezență fizică sau online. A1 fizic (Grupa 2) începe miercuri, 2 septembrie 2026, iar A2 fizic marți, 1 septembrie 2026. Grupa A1 online este în desfășurare și completă — te anunțăm când se deschide următoarea.",
    groupDetails: "Detalii curs",
    groupStartDate: "Data start",
    groupStartDateVal: "A1 fizic (Grupa 2): miercuri, 2 septembrie · A2 fizic: marți, 1 septembrie 2026 · A1 online: în desfășurare",
   ...
   priceFromLabel: "De la",
    ...
    cursTineriNote: "Grupele dedicate tinerilor (11–17) sunt în formare — aceeași organizare ca la adulți, dar cu colegi de aceeași vârstă. Până se formează grupa, ai două drumuri imediate mai jos.",
    cursTineriGroupTitle: "Grupă pentru tineri (11–17)",
  ...
  en: {
    ...
    groupDesc: "Physical or online presence. A1 in person (Group 2) starts Wednesday 2 September 2026 and A2 in person on Tuesday 1 September 2026. The A1 online group is in progress and full — we'll let you know when the next one opens.",
    groupDetails: "Course Details",
    groupStartDate: "Start Date",
    groupStartDateVal: "A1 in person (Group 2): Wednesday 2 September · A2 in person: Tuesday 1 September 2026 · A1 online: in progress",
   ...
   priceFromLabel: "From",
    ...
    cursTineriNote: "Dedicated teen groups (11–17) are being formed — same structure as the adult groups, but with peers your age. Until the group starts, you have two immediate paths below.",
    cursTineriGroupTitle: "Teen group (11–17)",
