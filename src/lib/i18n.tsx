...
const translations = {
  ro: {
    ...
    pricingGroupPriceFrom: "de la",
    pricingGroupPer: "LEI / lună · prețul variază în funcție de nivel",
    pricingGroupSeeLevels: "Vezi prețurile pe nivel (A1–B2) →",
  ...
  en: {
    ...
    pricingGroupPrice: "500",
    pricingGroupPriceFrom: "from",
    pricingGroupPer: "LEI / month · price depends on your level",
    pricingGroupSeeLevels: "See per-level pricing (A1–B2) →",
