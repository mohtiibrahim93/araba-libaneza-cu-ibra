...
const translations = {
  ro: {
    ...
    step1Desc: "Explorează programele noastre — grup, privat sau copii, online sau fizic în București.",
  ...
  en: {
    ...
    step1Desc: "Explore our programs — group, private or kids, online or in-person in Bucharest.",
