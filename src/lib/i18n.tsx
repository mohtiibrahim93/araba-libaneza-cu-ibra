...
const translations = {
  ro: {
    ...
    privateQuantityHelp: "Preț: 150 LEI / lecție. Reducerea de 10% se aplică automat la 15+ lecții.",
    privateQuantityDiscountApplied: "✓ Reducere 10% aplicată",
    privateQuantityDiscountHint: "Mai sunt {n} lecții până la −10%",
  ...
  en: {
    ...
    privateQuantityHelp: "Price: 150 LEI / lesson. The 10% discount is applied automatically at 15+ lessons.",
    privateQuantityDiscountApplied: "✓ 10% discount applied",
    privateQuantityDiscountHint: "{n} more lesson(s) to unlock −10%",
