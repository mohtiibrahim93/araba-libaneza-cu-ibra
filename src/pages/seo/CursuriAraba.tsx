...
const FAQ = [
  ...
  },
  {
    ...
    a: "Cursurile de grup pornesc de la 500 lei/lună (2 lecții de 90 de minute pe săptămână), cu 10% reducere la plata integrală a nivelului. Lecțiile private costă 150 lei/lecție, cu 15% reducere la pachete de 20+. Prima lecție de probă este gratuită.",
  },
  {
  ...
  >
    ...
    <ul>
      <li>
        ...
        mai motivant: grupe mici, 2 lecții de 90 min/săptămână, de la 500 lei/lună. Cohortele de
        august: A1 fizic (luni & miercuri, start 10 august), A1 online (weekend, start 15 august) și
        A2 (marți & joi, start 11 august).
      </li>
      <li>
