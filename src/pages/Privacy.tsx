...
const content = {
  ro: {
    ...
    sections: [
      ["1. Cine suntem", "„centrul de araba libaneza” este un proiect educațional care oferă cursuri de limbă arabă libaneză în București și online. Datele de contact: contact@centruldearabalibaneza.com."],
      ...
      ["5. Drepturile dumneavoastră", "Conform GDPR, aveți dreptul de a accesa, rectifica, șterge sau restricționa prelucrarea datelor dumneavoastră personale. Pentru orice solicitare, contactați-ne la contact@centruldearabalibaneza.com."],
      ...
      ["7. Contact", "Pentru întrebări legate de protecția datelor, ne puteți contacta la: contact@centruldearabalibaneza.com sau pe WhatsApp la +40 763 124 514."],
    ],
  },
  en: {
    ...
    sections: [
      ["1. Who we are", "“lebanese arabic center” is an educational project offering Lebanese Arabic language courses in Bucharest and online. Contact details: contact@centruldearabalibaneza.com."],
      ...
      ["5. Your rights", "Under GDPR, you have the right to access, correct, delete, or restrict the processing of your personal data. For any request, contact us at contact@centruldearabalibaneza.com."],
      ...
      ["7. Contact", "For questions about data protection, you can contact us at contact@centruldearabalibaneza.com or on WhatsApp at +40 763 124 514."],
    ],
  },
} as const;
