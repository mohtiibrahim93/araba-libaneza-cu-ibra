...
const CeEsteArabizi = () => {
  ...
  return (
    <BlogArticleLayout
      ...
      title={{ ro: "Ce este arabizi și cum îl folosești (cu tabel)", en: "What is Arabizi and how to use it (with a table)" }}
      description={{
        ro: "Arabizi este araba scrisă cu litere latine și cifre. Afli ce înseamnă cifrele 2, 3, 5, 7, cum citești și de ce e cea mai rapidă cale să începi să vorbești libaneză.",
