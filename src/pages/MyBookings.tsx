...
const COPY = {
  ro: {
    ...
    deadline: "Anularea sau reprogramarea este gratuită cu cel puțin 24 de ore înainte de lecție.",
  ...
  en: {
    ...
    deadline: "Cancellation or rescheduling is free at least 24 hours before the lesson.",
